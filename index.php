                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Discover your dream property with our expert real estate services. Your perfect home or investment opportunity awaits.".</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Discover the perfect rental properties with our comprehensive real estate rental service, connecting you to your ideal home or office space.".</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Discover your dream property with our comprehensive real estate listings, featuring homes and commercial spaces to suit your every need.".</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>"Discover our legal investment services tailored for real estate, ensuring your investments are secure and compliant.".</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p> Choose us for our wealth of expertise and years of experience in the real estate industry. Our seasoned professionals possess in-depth market knowledge, ensuring you make informed decisions and navigate the complexities of real estate transactions with confidence.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Comprehensive Property Portfolio</h5>
										<p>We offer a diverse and extensive property portfolio, catering to a wide range of needs and preferences. Whether you're seeking residential, commercial, or investment properties, we have the perfect options to match your requirements.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our commitment to customer satisfaction sets us apart. We provide personalized, attentive service, guiding you through every step of your real estate journey. Your success and peace of mind are our top priorities, making us the ideal choice for all your real estate needs.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Begin with a thorough discussion between the buyer and seller, covering property details, terms, and conditions to ensure mutual understanding and agreement.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Conduct a meticulous review of all relevant documents, including titles, permits, and contracts, to verify legal compliance and property history.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>After successful negotiations and due diligence, proceed to acquire the real estate through legal documentation, financial transactions, and transfer of ownership rights.</p>
                        </div>
                    </div>
                </div>
            </div>
